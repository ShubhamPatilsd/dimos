...
all_blueprints = {
    ...
    "coordinator-r1pro": "dimos.control.blueprints.r1pro:coordinator_r1pro",
    "coordinator-r1pro-arms": "dimos.control.blueprints.r1pro:coordinator_r1pro_arms",
    "r1pro-keyboard-teleop": "dimos.robot.galaxea.r1pro.blueprints.r1pro_keyboard_teleop:r1pro_keyboard_teleop",
    "r1pro-keyboard-teleop-full": "dimos.robot.galaxea.r1pro.blueprints.r1pro_keyboard_teleop:r1pro_keyboard_teleop_full",
    "r1pro-planner-coordinator": "dimos.manipulation.blueprints:r1pro_planner_coordinator",
